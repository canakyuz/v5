            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-7 space-y-6 md:space-y-8">
                ...
                <div className={`space-y-1 md:space-y-2 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
                  <h1 className="flex flex-col space-y-0 md:space-y-2">
                    <span className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light tracking-tight text-gray-900 dark:text-white">
                    ...
                    <span className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light tracking-tight text-gray-600 dark:text-gray-300 ml-3 md:ml-6">
                      {heroContent.name.last}
                    </span>
                  </h1>
                  
                  {/* Professional Title */}
                  <p className="text-sm md:text-base text-gray-600 dark:text-gray-400 font-light tracking-wide mt-2 md:mt-3">
                ...
                <div className={`max-w-2xl lg:max-w-3xl ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
                  <p className="text-sm md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 leading-relaxed font-light">
              ...
              <div className="lg:col-span-5 flex flex-col justify-center space-y-4 md:space-y-6 mt-4 lg:mt-0">
                ...
                <div className={`relative border border-gray-200 dark:border-gray-800 rounded-xl p-5 bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.7s' }}>
                  ...
                  <h3 className="text-lg md:text-xl font-medium text-gray-900 dark:text-white mb-1">Professional Journey</h3>
                  ...
                  <div className="space-y-3 mt-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm md:text-base font-medium text-gray-800 dark:text-gray-200">Mathematics Degree</h4>
                        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Built strong foundations in analytical thinking</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm md:text-base font-medium text-gray-800 dark:text-gray-200">Software Development</h4>
                        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Working at a tech company developing innovative solutions</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="text-sm md:text-base font-medium text-gray-800 dark:text-gray-200">Entrepreneurship</h4>
                        <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400">Building side projects and bringing ideas to life</p>
                      </div>
                    </div>
                  </div>
                </div>
