            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-12 lg:gap-16">
              ...
              <div className="lg:col-span-7 space-y-6 md:space-y-8">
                ...
                <div className={`space-y-1 md:space-y-2 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
                  <h1 className="flex flex-col space-y-0 md:space-y-2">
                    <span className="font-heading text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight text-gray-900 dark:text-white">
                    ...
                    <span className="font-heading text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold tracking-tight text-gray-600 dark:text-gray-300">
                      {heroContent.name.last}
                    </span>
                  </h1>
                  
                  {/* Professional Title */}
                  <p className="font-primary text-sm md:text-base text-gray-600 dark:text-gray-400 font-light tracking-wide mt-2 md:mt-3">
                ...
                <div className={`max-w-2xl lg:max-w-3xl ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.4s' }}>
                  <p className="font-primary text-sm md:text-lg lg:text-xl text-gray-700 dark:text-gray-300 leading-relaxed font-light">
                ...
                <div className={`pt-4 md:pt-8 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.6s' }}>
                  <div className="flex flex-col sm:flex-row gap-3 md:gap-6">
                    ...
                    >
                      <span className="font-primary font-medium tracking-wide text-sm md:text-base">
              ...
              <div className="lg:col-span-5 flex flex-col justify-center space-y-4 md:space-y-6 mt-4 lg:mt-0">
                ...
                <div className={`relative border border-gray-200 dark:border-gray-800 rounded-xl p-5 bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.7s' }}>
                  ...
                  <h3 className="font-heading text-lg md:text-xl font-medium text-gray-900 dark:text-white mb-1">Professional Journey</h3>
                  ...
                  <div className="space-y-3 mt-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-primary text-sm md:text-base font-medium text-gray-800 dark:text-gray-200">Mathematics Degree</h4>
                        <p className="font-primary text-xs md:text-sm text-gray-600 dark:text-gray-400">Built strong foundations in analytical thinking</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-primary text-sm md:text-base font-medium text-gray-800 dark:text-gray-200">Software Development</h4>
                        <p className="font-primary text-xs md:text-sm text-gray-600 dark:text-gray-400">Working at a tech company developing innovative solutions</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <h4 className="font-primary text-sm md:text-base font-medium text-gray-800 dark:text-gray-200">Entrepreneurship</h4>
                        <p className="font-primary text-xs md:text-sm text-gray-600 dark:text-gray-400">Building side projects and bringing ideas to life</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className={`grid grid-cols-2 gap-3 ${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.8s' }}>
                  <div className="group border border-gray-200 dark:border-gray-800 rounded-xl p-4 bg-white/70 dark:bg-gray-900/50 backdrop-blur-sm hover:border-blue-500/40 transition-all duration-300">
                    <div className="font-heading text-2xl md:text-3xl font-bold text-gray-900 dark:text-white mb-1">
                      <GradientText gradient="from-blue-400 to-purple-400">4+</GradientText>
                    </div>
                    <div className="font-primary text-xs font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide">
                      Years Experience
                    </div>
                  </div>
        ...
        <div className="absolute bottom-4 md:bottom-0 left-0 right-0 z-20">
          <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-12">
            <div className="flex items-center justify-between py-3 md:py-6 border-t border-gray-200 dark:border-gray-800/50 backdrop-blur-sm">
              ...
              >
                <span className="font-primary text-xs font-mono text-gray-600 dark:text-gray-400 tracking-wider uppercase">
                  Explore More
                </span>
