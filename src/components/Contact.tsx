...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-3 text-xs font-departure text-gray-500 tracking-wider uppercase mb-8">
            <div className="w-6 h-px bg-gray-300"></div>
            <span>{contactContent.sectionNumber}</span>
            <div className="w-6 h-px bg-gray-300"></div>
          </div>
          <h2 className="text-5xl md:text-7xl lg:text-8xl font-cooper font-light leading-[0.9] mb-6 text-gray-900">
            {contactContent.title.main}
            <br />
            <span className="italic text-gray-600">{contactContent.title.accent}</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div className="space-y-12">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <a 
                  ...
                  className="text-gray-900 hover:text-gray-600 transition-colors font-inter"
                >
            ...
            <div className="pt-8 border-t border-gray-200">
              <h3 className="text-xs font-departure text-gray-500 mb-4 tracking-[0.2em] uppercase">
                ...
                {contactContent.social.links.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="w-10 h-10 border border-gray-300 rounded-full flex items-center justify-center hover:border-gray-900 hover:bg-gray-900 transition-all duration-300 group"
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={5}
                  className="w-full px-4 py-3 border border-gray-200 rounded-md focus:border-gray-900 focus:ring-2 focus:ring-gray-900 focus:ring-opacity-20 resize-none transition-colors"
                />
              </div>
