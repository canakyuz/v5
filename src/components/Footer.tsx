...
export default function Footer() {
  ...
  return (
    <footer className="bg-black/20 backdrop-blur-md py-8 border-t border-white/5 mt-12" id="contact">
          ...
          <div className="md:col-span-5">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li className="flex items-center gap-3 text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors group">
                ...
                <span className="group-hover:translate-x-1 transition-transform duration-300">İstanbul, Türkiye</span>
              </li>
            </ul>
          </div>
        </div>
