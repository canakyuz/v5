    ...
    <div className={`${grid.sidebar} ${className}`}>
      <div className={grid.sticky}>
        ...
        <div className={`${isLoaded ? 'animate-fade-in' : 'opacity-0'}`} style={{ animationDelay: '0.2s' }}>
          ...
          <div className="w-16 h-px bg-gradient-to-br from-slate-950 via-gray-900 to-gray-950 dark:from-slate-950 dark:via-gray-900 dark:to-gray-950 light:from-gray-50 light:via-white light:to-gray-100 border-t border-gray-700/60 dark:border-gray-700/60 light:border-gray-200"></div>
        </div>
      </div>
    </div>
  );
