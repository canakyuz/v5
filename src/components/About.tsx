        ...
        <div className="grid grid-cols-12 gap-8">
          ...
          <div className="col-span-12 lg:col-span-8">
            <div className="space-y-32">
              ...
              {/* Skills - Enhanced with 3 categories */}
              <div className="space-y-24">
                {/* Core Technologies */}
                <div className="relative">
                  <div className="absolute -left-12 top-0 w-2 h-24 bg-gradient-to-b from-gray-900 to-gray-600"></div>
                  <div className="pl-16">
                      ...
                      {aboutContent.skills.frontend.items.map((skill, index) => (
                        <div key={skill.name} className="group hover:transform hover:translate-x-2 transition-all duration-300">
                          <div className="flex items-center justify-between mb-2">
                            <div className="font-departure text-xs text-gray-300 tracking-[0.2em]">{String(index + 1).padStart(2, '0')}</div>
                            <span className="text-xs font-departure text-gray-400 bg-gray-100 px-2 py-1 rounded uppercase tracking-wide">
                              {skill.level}
                            </span>
                          </div>
                          <div className="text-gray-900 font-inter font-medium text-lg">{skill.name}</div>
                          <div className="text-sm text-gray-400 mt-1 leading-relaxed">{skill.description}</div>
                        </div>
                      ))}
                    </div>
                  </div>
                ...
                {/* Tools & Methodologies */}
                <div className="relative">
                  <div className="absolute -left-12 top-0 w-2 h-24 bg-gradient-to-b from-gray-600 to-gray-400"></div>
                  <div className="pl-16">
                    <h3 className="text-3xl font-cooper font-light text-gray-900 mb-12 tracking-wide">{aboutContent.skills.tools.title}</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
                ...
                <div className="relative">
                  ...
                  <div className="pl-16">
                    <h3 className="text-3xl font-cooper font-light text-gray-900 mb-12 tracking-wide">{aboutContent.skills.architecture.title}</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
